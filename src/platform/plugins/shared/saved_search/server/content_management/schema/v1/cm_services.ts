...
import { SCHEMA_DISCOVER_SESSION_V13 } from '../../../saved_objects/schema';

const savedSearchSavedObjectSchema = savedObjectSchema(SCHEMA_DISCOVER_SESSION_V13);
...
export const serviceDefinition: ServicesDefinition = {
  ...
  create: {
    in: {
      ...
      data: {
        schema: SCHEMA_DISCOVER_SESSION_V13,
      },
    },
    out: {
      result: {
